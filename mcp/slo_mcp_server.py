...
mcp = FastMCP(
    ...
    instructions="You have access to a live Bitcoin, Ethereum, and EUR/USD price oracle on the Lightning Network. Each query costs real sats (10 for spot, 20 for VWAP) paid automatically via Lightning. Responses are cryptographically signed and independently verifiable."
)
...
def get_eurusd_spot() -> dict:
    ...
    and Bitstamp with a cryptographic signature."""
